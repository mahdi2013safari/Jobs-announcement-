...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{ asset('/style_land_page/css/bootstrap.min.css') }}">
    <!-- Themify Icons -->
    <link rel="stylesheet" href="{{ asset('/style_land_page/css/themify-icons.css') }}">
    <!-- Owl carousel -->
    <link rel="stylesheet" href="{{ asset('/style_land_page/css/owl.carousel.min.css') }}">
    <!-- Main css -->
    <link href="{{ asset('/style_land_page/css/style.css') }}" rel="stylesheet">
</head>
        ...
        <div class="row">
            <div class="col-md-12">
                <nav class="navbar navbar-dark navbar-expand-lg">
                    <a class="navbar-brand" href="index.html"><img src="{{ asset('/style_land_page/images/logo.png') }}" class="img-fluid" alt="logo"></a> <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbar" aria-controls="navbar" aria-expanded="false" aria-label="Toggle navigation"> <span class="navbar-toggler-icon"></span> </button>
...
<header class="bg-gradient" id="home">
    ...
    <div class="img-holder mt-3"><img src="{{ asset('/style_land_page/images/iphonex.png') }}" alt="phone" class="img-fluid"></div>
</header>

<div class="client-logos my-5">
    <div class="container text-center">
        <img src="{{ asset('/style_land_page/images/client-logos.png') }}" alt="client logos" class="img-fluid">
    </div>
</div>
...
<div class="section">
    ...
    <div class="container">
        ...
        <div class="perspective-phone">
            <img src="{{ asset('/style_land_page/images/perspective.png') }}" alt="perspective phone" class="img-fluid">
        </div>
    </div>
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active" id="communication">
                <div class="d-flex flex-column flex-lg-row">
                    <img src="{{ asset('/style_land_page/images/graphic.png') }}" alt="graphic" class="img-fluid rounded align-self-start mr-lg-5 mb-5 mb-lg-0">
                    <div>
...
<div class="section">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="{{ asset('/style_land_page/images/dualphone.png') }}" alt="dual phone" class="img-fluid">
            </div>
...
<div class="section light-bg">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <img src="{{ asset('/style_land_page/images/iphonex.png') }}" alt="iphone" class="img-fluid">
            </div>
    ...
    <div class="container">
        <div class="call-to-action">
            ...
            <div class="my-4">
                ...
                <a href="#" class="btn btn-light"><img src="{{ asset('/style_land_page/images/appleicon.png') }}" alt="icon"> App Store</a>
                <a href="#" class="btn btn-light"><img src="{{ asset('/style_land_page/images/playicon.png') }}" alt="icon"> Google play</a>
            </div>
...
<script src="{{ asset('/style_land_page/js/jquery-3.2.1.min.js') }}"></script>
<script src="{{ asset('/style_land_page/js/bootstrap.bundle.min.js') }}"></script>
<!-- Plugins JS -->
